...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const roleDefaultPerms = { clients_view: true, clients_manage: true, orders_view: true, reports_view: true };
  const perms = (role === 'admin') ? roleDefaultPerms : (roleHasAccess ? roleDefaultPerms : (profile?.app_metadata?.finanzas?.permissions || {}));
